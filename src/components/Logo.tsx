    ...
    <div className={`flex flex-col items-center ${className}`} style={style}>
      <div className="flex">
        <div className="relative w-10 h-10">
          ...
          <img src="/lovable-uploads/f2cf4cca-6d64-4692-8a1f-c68bffa3edee.png" alt="Gray link 1" className="absolute inset-0 w-full h-full" />
          <img src="/lovable-uploads/d94d808e-1eed-4566-9498-54699d91705c.png" alt="Gray link 2" className="absolute inset-0 w-full h-full" />
        </div>
      </div>
