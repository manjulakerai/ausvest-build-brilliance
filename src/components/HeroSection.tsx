...
const HeroSection = () => {
  return (
    <section className="relative h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center" role="banner">
      <div className="absolute inset-0 bg-[url('/lovable-uploads/2a70cfa3-f02b-4a19-b64b-97bf622bd4e6.png')] bg-cover bg-center opacity-60 mix-blend-multiply" aria-hidden="true"></div>
